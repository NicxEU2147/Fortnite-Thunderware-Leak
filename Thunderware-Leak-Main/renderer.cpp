//Hahahahahahah you shit fucking scammer (thunderchro) get fucked by NicxEU#2147 also if you are using this shit curtosy of NicxEU plz join the server https://discord.gg/fbMBeaTXgv do not ask for help you fucking skid cause i wont help your retard ass
...
if (showMenu)
{
	...
	if (ImGui::Begin(xorstr("Thunderware"), 0, ImGuiWindowFlags_::ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_::ImGuiWindowFlags_NoResize)) {
		ImGui::SetWindowSize(ImVec2(304, 238.0f));
		static int tabs = 0;
		if (ImGui::Button("Softaim", ImVec2(95.0f, 20.f)))
